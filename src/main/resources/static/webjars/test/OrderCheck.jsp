...
border-bottom-right-radius: 5px;
                ...
                <ol class="progtrckr" data-progtrckr-steps="5">
                  ...
                  <li id="msuccess" class="progtrckr-todo";>制作完成</li>
                  <li class="progtrckr-todo">已取货</li>
                </ol>
              ...
              <table id="example2" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                        ...
                        <td>
                          <div align="center"><b><font color="#0099FF">制作中</font></b><br/>
                          <a><p class="bb">完 成</p></a>
                  ...
                  <tr>
                        ...
                        <td>
                          <div align="center"><b>尚未制作</b><br/>
                            <a><p class="aa">制 作</p></a>
                          </div>
                        </td>
                  </tr>
    ...
    <script>
		var sHtml2 = "<font color=\"33CC33\">制作完成</font>";
	var sHtml3 = "<font size=\"+1\"; color=\"33CC33\"><b>等 待 取 货</b></font>";
	  $('.cc').click(function(){
